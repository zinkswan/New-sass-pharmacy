                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <select @change="showCategoryId()" v-model="products.categoryId">
...
export default {
    ...
    methods: {
        async showProduct() {
            ...
            axios
                ...
                .then((response) => {
                    ...
                    this.products.id = id;
                    this.products.productName = productName;
                    this.products.sku = sku;
                    this.products.categoryId = categoryId;
                    this.products.typeId = typeId;
                    this.products.providerId = providerId;
                    this.products.status = status;
                    this.products.tax = tax;
                    this.products.quantity = quantity;
                    this.products.minQuantity = minQuantity;
                    this.products.sellingPrice = sellingPrice;
                    this.products.buyingPrice = buyingPrice;
        ...
        saveData() {
            ...
            axios.post('/api/products/create', this.products).then(
                response => {
                    console.log(response);
                }
            ).catch(error => {
        ...
        updateProduct() {
            // Send a POST request to the backend to create a new product
            axios
                .put("/api/product/update/" + this.products.id, {
                    id:this.products.id,
                    productName:this.products.productName,
                    sku:this.products.sku,
                    categoryId:this.products.categoryId,
                    typeId:this.products.typeId,
                    providerId:this.products.providerId,
                    status:this.products.status,
                    tax:this.products.tax,
                    quantity:this.products.quantity,
                    minQuantity:this.products.minQuantity,
